      ...
      <div className="pt-18 justify-left">
        {data.map((data) => {
          return (
            ...
            >
              <div className="text-brown font-heading text-2xl lg:text-4xl flex pl-10 pt-10">
                {" "}
                {data.title}{" "}
              </div>
              <div className="text-brown font-body text-sm lg:text-lg flex px-12 lg:px-24 py-10">
